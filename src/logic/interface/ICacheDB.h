...
public:
	...
	virtual s8 GetDataInt8(s32 row, s32 col) = 0;
	virtual s16 GetDataInt16(s32 row, s32 col) = 0;
	virtual s32 GetDataInt32(s32 row, s32 col) = 0;
	virtual s64 GetDataInt64(s32 row, s32 col) = 0;
	virtual float GetDataFloat(s32 row, s32 col) = 0;
	virtual const char * GetDataString(s32 row, s32 col) = 0;
	virtual const void * GetStruct(s32 row, s32 col, const s32 size) = 0;
	virtual const void * GetBlob(s32 row, s32 col, s32& size) = 0;
};
...
public:
	...
	virtual void WriteStruct(const char * col, const void * context, const s32 size) = 0;
